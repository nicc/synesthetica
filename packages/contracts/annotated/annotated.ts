 ...
 *
 * Per-note continuous pitch deviation (for audio sources) lives on
 * the underlying Note as `pitchTrajectory` — it's observed musical
 * data, not annotation. See SPEC 012.
 */
