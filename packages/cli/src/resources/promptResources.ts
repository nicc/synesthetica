...
function renderToolResultShape(): string {
  return [
    ...
    "- Read `intents` to answer 'what has the user asked for?'. Read `effective` to answer 'what is the pipeline actually doing right now?'. A divergence between them signals a wiring bug worth reporting.",
    "",
